...
class LocalgovIntegrationTest extends BrowserTestBase {
  ...
  protected function setUp(): void {
    parent::setUp();
    // Install localgov_core here to include optional configuration in D11.
    ...
    $this->container->get('module_installer')->install(['localgov_services_landing'], TRUE);
    $this->container->get('module_installer')->install(['localgov_services_sublanding'], TRUE);
