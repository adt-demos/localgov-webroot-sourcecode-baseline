...
abstract class SubsitesAbstractBlockBase extends BlockBase implements ContainerFactoryPluginInterface {
   ...
   */
  public function __construct(array $configuration, $plugin_id, $plugin_definition, EntityTypeManagerInterface $entity_type_manager, EntityTreeNodeMapperInterface $entity_tree_node_mapper) {
