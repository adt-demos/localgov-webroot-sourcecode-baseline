...
class ScheduledTransitionModalFormTest extends BrowserTestBase {
  ...
  public function testNoRevisionLinkTemplate(): void {
    ...
    $plugin = $workflow->getTypePlugin();
    static::assertInstanceOf(ContentModerationInterface::class, $plugin);
    $plugin->addEntityTypeAndBundle('st_entity_test_norevtemplate', 'st_entity_test_norevtemplate');
    $workflow->save();
    ...
    static::assertFalse($entity->getEntityType()->hasLinkTemplate('revision'));
