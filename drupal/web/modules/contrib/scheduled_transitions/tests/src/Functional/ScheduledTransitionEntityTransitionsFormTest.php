...
class ScheduledTransitionEntityTransitionsFormTest extends BrowserTestBase {
  ...
  protected function setUp(): void {
    ...
    $plugin = $this->workflow->getTypePlugin();
  ...
  public function testForm(): void {
    ...
    $this->assertSession()->pageTextContains('On Fri, 14 Dec 2012 - 12:00');
    ...
    $this->drupalGet($entity->toUrl(RouteProvider::LINK_TEMPLATE));
    $this->assertSession()->elementsCount('css', 'table tbody tr', 1);
    $this->assertSession()->linkExists('Fri, 14 Dec 2012 - 12:00');
  }
  ...
  public function testTransitionsByPageLanguage(): void {
    ...
    $this->assertSession()->elementTextContains('css', 'table tr:nth-child(1) > td:nth-child(5)', (string) $author->label());
