...
class ScheduledTransitionsPermissionsTest extends KernelTestBase {
  ...
  public function testPermissions(): void {
    ...
    static::assertArrayHasKey('view scheduled transitions entity_test_revlog entity_test_revlog', $permissions);
    static::assertArrayHasKey('add scheduled transitions entity_test_revlog entity_test_revlog', $permissions);
  }
