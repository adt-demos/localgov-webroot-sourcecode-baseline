...
class ScheduledTransitionsRouteProvider implements EntityRouteProviderInterface {
   ...
   *   The route name.
   */
  public static function getScheduledTransitionRouteName(EntityTypeInterface $entityType): string {
   ...
   *   The route name.
   */
  public static function getScheduledTransitionAddRouteName(EntityTypeInterface $entityType): string {
