 ...
 */
final class ScheduledTransitionsEntityHooks implements ContainerInjectionInterface {
   ...
   */
  protected function loadByHostEntity(RevisionableInterface $entity, bool $revision_match = FALSE): array {
    $transitionStorage = $this->entityTypeManager->getStorage('scheduled_transition');
