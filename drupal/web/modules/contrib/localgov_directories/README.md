...
## Drupal 11.3, body field storage and PHPUnit tests

We aim to support Drupal 10 and Drupal 11, so our phpunit tests need to do the
same. Since Drupal 11.3 does not include field storage for the body field, we
have to depend the appropriate localgov_core version to include this for 11.3+.

  - localgov_core 2.x supports Drupal 10.
  - localgov_core 3.x supports Drupal 11.3+
