...
class PagesIntegrationTest extends BrowserTestBase {
  ...
  protected function setUp(): void {
    ...
    $this->container->get('module_installer')->install(['localgov_services']);
    $this->container->get('module_installer')->install(['localgov_services_landing']);
    $this->container->get('module_installer')->install(['localgov_services_sublanding']);
    $this->container->get('module_installer')->install(['localgov_services_page']);
    $this->container->get('module_installer')->install(['localgov_services_navigation']);
    $this->container->get('module_installer')->install(['localgov_topics']);
    $this->container->get('module_installer')->install(['localgov_search']);
    $this->container->get('module_installer')->install(['localgov_search_db']);
    $this->container->get('module_installer')->install(['localgov_step_by_step']);
