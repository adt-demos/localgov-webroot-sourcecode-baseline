 ...
 */
class ReinstallTest extends PublicationsTestBase {
  ...
  public function testReinstall() {
    ...
    $this->assertTrue($moduleHandler->moduleExists('localgov_publications'), "Module not installed.");
    ...
    $this->assertFalse($moduleHandler->moduleExists('localgov_publications'), "Module not uninstalled.");

    // Install module.
    $this->assertTrue($moduleInstaller->install(['localgov_publications']), "Couldn't reinstall module.");
  }
